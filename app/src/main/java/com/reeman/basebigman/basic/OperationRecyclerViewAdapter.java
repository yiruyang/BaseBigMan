...
public class OperationRecyclerViewAdapter extends RecyclerView.Adapter<OperationRecyclerViewAdapter.RecyclerViewHolder> {
    ...
    public OperationRecyclerViewAdapter(Context context) {
        mContext = context;
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RecyclerViewHolder(mLayoutInflater.inflate(R.layout.common_operation_item, parent, false));
    }
    ...
    public static class RecyclerViewHolder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.operation_video_name)
        TextView videoName;
    ...
    public void getData(){
        File path = new File(OPERATIONURL);
        if (path != null){
